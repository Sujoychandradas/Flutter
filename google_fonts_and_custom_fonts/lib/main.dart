...
import 'package:google_fonts_and_custom_fonts/example.dart';
import 'package:google_fonts_and_custom_fonts/splash.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
          ...
          //   Theme.of(context).textTheme.apply(fontSizeDelta: 20),
          // ),
